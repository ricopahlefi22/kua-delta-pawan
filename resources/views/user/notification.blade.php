                ...
                <div class="main">
                    <div class="page-header">
                        ...
                        <div class="breadcrumb">
                           ...
                           <div class="breadcrumb-item"><a href="h-profile-connect.html"> profile </a></div>
                        </div>
                    </div>
                    <div class="card">
                            ...
                            <div class="row content-min-height">
                                <div class="p-0 column-panel border-end" style="max-width: 230px; min-width: 230px; left: -230px;">
                                    ...
                                    <div class="columns-panel-item-group">
                                        <a class="columns-panel-item columns-panel-item-link" href="h-profile-personal.html">
                                            <div class="d-flex align-items-center">
                                                <i class="feather font-size-lg icon-user"></i>
                                                <span class="ms-3">Personal</span>
                                            </div>
                                        </a>
                                        <a class="columns-panel-item columns-panel-item-link active" href="h-profile-notification.html">
                                            <div class="d-flex align-items-center">
                                                <i class="feather font-size-lg icon-bell"></i>
                                                <span class="ms-3">Notification</span>
                                            </div>
                                        </a>
                                        <a class="columns-panel-item columns-panel-item-link" href="h-profile-security.html">
                                            <div class="d-flex align-items-center">
                                                <i class="feather font-size-lg icon-lock"></i>
                                                <span class="ms-3">Security</span>
                                            </div>
                                        </a>
                                        <a class="columns-panel-item columns-panel-item-link" href="h-profile-connect.html">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-body">
                                        <div class="d-md-flex align-items-center justify-content-between">
                                            <div>
                                                ...
                                                <p class="mb-0">Allow notification for the enabled section.</p>
                                            </div>
                                        </div>
                                        <div class="mt-4">
                                            <div class="mb-4">
                                                ...
                                                <div class="p-3 border-bottom">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-md-center">
                                                            <i class="feather h2 text-primary mb-0 icon-message-circle"></i>
                                                            <div class="ms-3">
                                                                <div class="text-dark fw-bolder">Comments</div>
                                                                <p class="mb-0">Receive a notifications when someone is comment on your post.</p>
                                                            </div>
                                                        </div>
                                                        <div class="ms-3">
                                                            <div class="form-check form-switch">
                                                                <label role="checkbox" class="form-check-label">
                                                                    <input type="checkbox" role="switch" class="form-check-input" name="switch" checked>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="p-3 border-bottom">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-md-center">
                                                            <i class="feather h2 text-primary mb-0 icon-mail"></i>
                                                            <div class="ms-3">
                                                                <div class="text-dark fw-bolder">Email</div>
                                                                <p class="mb-0">Receive daily email notifications.</p>
                                                            </div>
                                                        </div>
                                                        <div class="ms-3">
                                                            <div class="form-check form-switch">
                                                ...
                                                <div class="p-3 border-bottom">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-md-center">
                                                            <i class="feather h2 text-primary mb-0 icon-star"></i>
                                                            <div class="ms-3">
                                                                <div class="text-dark fw-bolder">Item review</div>
                                                                <p class="mb-0">Receive email when someone rate your product.</p>
                                                            </div>
                                                        </div>
                                                        <div class="ms-3">
                                                            <div class="form-check form-switch">
                                                                <label role="checkbox" class="form-check-label">
                                                                    <input type="checkbox" role="switch" class="form-check-input" name="switch">
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="p-3 border-bottom">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-md-center">
                                                            <i class="feather h2 text-primary mb-0 icon-user-plus"></i>
                                                            <div class="ms-3">
                                                                <div class="text-dark fw-bolder">Follows</div>
                                                                <p class="mb-0">Receive a notifications when someone follow you.</p>
                                                            </div>
                                                        </div>
                                                        <div class="ms-3">
                                                            <div class="form-check form-switch">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="p-3 border-bottom">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-md-center">
                                                            <i class="feather h2 text-primary mb-0 icon-box"></i>
                                                            <div class="ms-3">
                                                                <div class="text-dark fw-bolder">New product</div>
                                                                <p class="mb-0">Receive a notifications when a new product arrived.</p>
                                                            </div>
                                                        </div>
                                                        <div class="ms-3">
                                                            <div class="form-check form-switch">
                                                ...
                                                <div class="p-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-md-center">
                                                            <i class="feather h2 text-primary mb-0 icon-tag"></i>
                                                            <div class="ms-3">
                                                                <div class="text-dark fw-bolder">Product discount</div>
                                                                <p class="mb-0">Receive a notifications when product discount.</p>
                                                            </div>
                                                        </div>
                                                        <div class="ms-3">
                                                            <div class="form-check form-switch">
