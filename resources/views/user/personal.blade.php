                                    ...
                                    <div class="col-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="gender" id="male"
                                                value="1"
                                                @if (!empty($personal_data)) {{ $personal_data->gender == 1 ? 'checked' : null }} @endif>
                                    ...
                                    <div class="col-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="gender" id="female"
                                                value="2"
                                                @if (!empty($personal_data)) {{ $personal_data->gender == 2 ? 'checked' : null }} @endif>
                                    ...
                                    <div class="col-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status" id="virgin"
                                                value="1"
                                                @if (!empty($personal_data)) {{ $personal_data->status == 1 ? 'checked' : null }} @endif>
                                    ...
                                    <div class="col-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status" id="divorce"
                                                value="2"
                                                @if (!empty($personal_data)) {{ $personal_data->status == 2 ? 'checked' : null }} @endif>
