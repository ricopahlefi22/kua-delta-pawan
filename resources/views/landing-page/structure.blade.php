...
<head>
    ...
    <title>Struktur Organisasi | Kantor Urusan Agama Delta Pawan</title>
...
<body id="page-top">
    ...
    <section class="page-title-section about-us-two" data-stellar-background-ratio="0.1">
        <div class="container">
      ...
      <!-- hero-block-v4 -->
      <section class="hero-block-v4" style="margin-bottom: 100px;">
          <div class="container">
              ...
              <div class="row">
                  <div class="col-md-7">
                      <div class="company-overview">
                          ...
                          <p>Berikut adalah Struktur Organisasi dari Kantor Urusan Agama Delta Pawan.</p>
                      </div><!-- /.company-overview -->
                  </div>

                  <div class="col-md-5 overview-img-wrapper">
                      <img src="images/structure.jpeg" class="img-responsive " alt="Image">
                  </div>
              </div>
